...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "The platform for globally-minded students and early-career professionals — a curated opportunity directory, instant expert-designed application help, vetted insider coaches, and direct access to employers." },
