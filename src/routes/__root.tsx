    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          description: "Discover Diplomacy for global careers — a directory of opportunities, instant application help, vetted coaches, and direct access to verified employers.",
